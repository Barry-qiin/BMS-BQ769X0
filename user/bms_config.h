...
#define INIT_OV_DELAY		OV_DELAY_2s		// 充电过压保护延时时间	OV:Over	Voltage
#define INIT_UV_DELAY 		UV_DELAY_4s		// 放电欠压保护延时时间 UV:Under Voltage

#define INIT_OCDThreshold   OCD_THRESH_17mV_8mV  // 放电过流保护阈值(mV)
#define INIT_OCD_DELAY		OCD_DELAY_320ms // 放电过流延时时间(S) OCD:Over Current Discharge
#define INIT_OCD_RELIEVE	60					// 放电过流解除时间(S)

#define INIT_SCDThreshold   SCD_THRESH_89mV_44mV  // 放电短路保护阈值(mV)
#define INIT_SCD_DELAY		SCD_DELAY_100us	// 放电短路延时时间(us) SCD:Short Circuit Discharge
